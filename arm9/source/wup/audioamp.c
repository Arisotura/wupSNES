...
// regular audio amplifier config has NDAC=2 and MADC=2, for an audio frequency of 48KHz
// we change those parameters to 3 for 32KHz
...
static u16 AAmpInit1[0x1E*2] = {
    ...
    0x8043, 0,
    0x0000, 0,
    0x0304, 0,      // codec_clkin = pll_clk
    0x9105, 0,      // P = 1, R = 1
    0x0506, 0,      // J = 5
    0x0E07, 0,      //
    0xB008, 15,     // D = 3760
    0x0C1B, 0,      // BCLK and WCLK = output
    0x8E1E, 0,      // BCLK divider = 14
    0x033C, 0,
